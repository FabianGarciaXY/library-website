...
// === GENRE ROUTES === //
// GET request for creating a Genre. Must come before route that displays Genre (uses id).
...
/// BOOKINSTANCE ROUTES ///
// GET request for creating a BookInstance. Must come before route that displays BookInstance (uses id).
